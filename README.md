...
| Sep 1992 | September 1992 | SAS 70 & COSO | Auditors · AICPA + COSO | AICPA's Statement on Auditing Standards 70 enabled service-organization audits; COSO published its Internal Control Integrated Framework. | Introduced third-party assurance reporting — the direct ancestor of SOC 2. | https://www.coso.org/internal-control |
...
| Aug 1996 | August 21, 1996 | HIPAA & COBIT | Governments + Auditors · HHS / ISACA | US healthcare privacy and security law (HIPAA); ISACA's Control Objectives for Information and Related Technologies (COBIT) framework. | Established sector-specific compliance regulation and an IT governance framework still widely audited against. | https://www.hhs.gov/hipaa/for-professionals/index.html |
| Jul 2002 | July 30, 2002 | SOX & FISMA | Governments · US Congress | Sarbanes-Oxley imposed financial reporting controls on public companies; FISMA mandated security programs across federal agencies. | Birth of the modern compliance industry — created enormous demand for control documentation and audit work. | https://www.govinfo.gov/app/details/PLAW-107publ204 |
| 2002 | 2002 | OCEG & The Red Book | Analysts · OCEG | The Open Compliance and Ethics Group was founded and published its Red Book GRC Capability Model. | Coined the umbrella term "GRC" itself. | https://www.oceg.org/ideas/what-is-grc/ |
| 2004 | 2004 | OCEG Red Book Published | Analysts · OCEG | The Open Compliance and Ethics Group published its GRC Capability Model "Red Book". | Established first capability model for GRC. | https://www.oceg.org/20-years/#:~:text=GRC%20Defined%2C%20Red%20Book%20Released |
...
| 2021 | June 1, 2021 | Netflix hires first proto-GRC Engineer | Engineers · Netflix | Netflix posted some of the first job descriptions explicitly titled "GRC Engineer," applying engineering practices to compliance. | Marked the emergence of GRC as an engineering discipline rather than a purely auditor-driven function. | https://www.linkedin.com/in/mosi-k-platt/ |
...
| 2024 | July 15, 2024 | GRC Engineering Manifesto published | Engineer · Community | A community-authored manifesto codifying the principles of GRC Engineering at grc.engineering. | Crystallized the discipline's values — engineering practices, automation, design thinking — into a shared artifact. | https://grc.engineering/ |
